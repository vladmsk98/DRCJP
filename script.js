...
const galleryData = [
  ...
  },
  {
    ...
    description: "На фотографии изображено японское слово 「変化」(henka), которое переводится как «изменение» или «перемена». Это слово отражает эволюцию и трансформацию, представленные в визуальном образе работы.",
